...
exports.default = function (element, template) {
...
var _mainpage3 = __webpack_require__(18);

var _mainpage4 = _interopRequireDefault(_mainpage3);
...
var _leaderboards2 = __webpack_require__(40);

var _leaderboards3 = _interopRequireDefault(_leaderboards2);
...
var checkLogin = function checkLogin() {
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      ...
      (0, _render2.default)(document.getElementById('page'), (0, _login2.default)());
      (0, _login4.default)();
    }
  });
};

var renderPageContainer = function renderPageContainer(user) {
  (0, _render2.default)(document.getElementById('page'), (0, _mainpage2.default)({
    user: user
  }));
  ...
  _lodash2.default.each(navLinks, function (link) {
...
var initRouter = function initRouter() {
  routie({
    '': function _() {
      (0, _mainpage4.default)();
    },
    'leaderboards': function leaderboards() {
      (0, _leaderboards3.default)();
    }
  });
};
...
var checkMenuStatus = function checkMenuStatus(e) {
...
var navLinkClick = function navLinkClick(e) {
  checkMenuStatus();
};
...
var __t, __p = '';
with (obj) {
__p += '<div class="container container--content-center container--full-height">\n  <div class="content-block align-center">\n  	<h1 id="page-header">World Cup 2018</h1>\n  	<button class="button button--green" id="login">Login</button>\n  </div>\n</div>';
...
'</p>\n <h2 id="user-score"></h2>\n <button class="text-button text-button--invert" id=\'openmenu\'>MENU</button>\n</nav>\n<div id="matchlist"></div>\n<div id="menu">\n  <button class="close-menu" id=\'closemenu\'><i class="far fa-times-circle"></i></button>\n  <div class="menu-content">\n      <ul class="menu-links">\n        <li><a href="/#" class="nav-link">Mainpage</a></li>\n        <li><a href="/#leaderboards" class="nav-link">Leaderboard</a></li>\n        <li><a href="#" id=\'logout\'>Logout</a></li>\n      </ul>\n  </div>\n</div>';
...
var _matchlist = __webpack_require__(38);

var _matchlist2 = _interopRequireDefault(_matchlist);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var dev = checkQueryString('dev');
var matchUrl = dev ? '../js/testData.json' : 'https://raw.githubusercontent.com/openfootball/world-cup.json/master/2018/worldcup.json';
...
var loadMatchData = function loadMatchData() {
  _axios2.default.get(matchUrl).then(function (response) {
...
var renderMatchData = function renderMatchData(data) {
  (0, _render2.default)(document.getElementById('matchlist'), (0, _matchlist2.default)({
    data: data
  }));
  var betForms = document.getElementsByClassName('bettingform');
  _.each(betForms, function (form) {
    form.addEventListener('submit', addUserBet, false);
  });
};

var addUserBet = function addUserBet(e) {
  e.preventDefault();
  var current = e.currentTarget;
  var matchnum = current.getAttribute('data-match-num');
  var roundI = current.getAttribute('data-round-index');
  var matchI = current.getAttribute('data-match-index');
  var picked = matchData.rounds[roundI].matches[matchI];
  var formdata = new FormData(current);
  var object = {
    num: matchnum
  };
  ...
  var emptyStrings = _.includes(_.values(object), "");

  if (!emptyStrings) {
    firebase.database().ref('bets/' + uid + '/matches/' + matchnum).set(object, function (err) {
      if (err) {
        showStatus(false);
      } else {
        showStatus(true);
...
var userBets = function userBets() {
  var uid = sessionStorage.getItem('userid');
  firebase.database().ref('bets/' + uid).once('value', function (res) {
    if (res.val().matches) {
...
var combineMatchData = function combineMatchData(bets) {
  var betsList = void 0;
  ...
  _.each(matchData.rounds, function (round) {
    _.each(round.matches, function (match) {
      _.each(betsList, function (bet) {
...
var showStatus = function showStatus(success) {
  var notification = document.getElementById('notification');
  var statusClass = success ? 'success' : 'error';
  var content = success ? 'Bet Added!' : 'Error try again!';
...
var checkScores = function checkScores(data) {
...
var checkBets = function checkBets(match) {
...
var saveUserScore = function saveUserScore(score) {
  var uid = sessionStorage.getItem('userid');
  firebase.database().ref('bets/' + uid + '/points/').set(score, function (err) {
    if (err) {
      console.log(err);
    } else {
...
function print() { __p += __j.call(arguments, '') }
with (obj) {
__p += '<div class="mainpage">\n  <div class="matchdays">\n    ';
 _.each(data.rounds,function(round,i){ ;
__p += '\n    <div class="day">\n      <h1>' +
((__t = (round.name)) == null ? '' : __t) +
'</h1>\n      <div class="matches">\n        ';
...
__p += '\n            <div class="container container--info-row ' +
((__t = (infoClass)) == null ? '' : __t) +
'">\n              <p>' +
((__t = (match.group)) == null ? '' : __t) +
'</p>\n              <p>' +
((__t = (match.date)) == null ? '' : __t) +
' ' +
((__t = (match.time)) == null ? '' : __t) +
'</p>\n            </div>\n            <div class="container container--match-row">\n              <h2>' +
((__t = (match.team1.name)) == null ? '' : __t) +
'</h2>\n              ';
 if(match.score1 !== null && match.score2 !== null) { ;
__p += '\n              <h2 class="align-center">' +
((__t = (match.score1 + '-' + match.score2)) == null ? '' : __t) +
'</h2>\n              ';
 } ;
__p += '\n              <h2 class="align-right">' +
((__t = (match.team2.name)) == null ? '' : __t) +
'</h2>\n            </div>\n            <form class=\'bettingform\' data-match-index=\'' +
((__t = (j)) == null ? '' : __t) +
'\' data-round-index=\'' +
((__t = (i)) == null ? '' : __t) +
'\' data-match-num=\'' +
((__t = (match.num)) == null ? '' : __t) +
'\'>\n              <div class="container container--betting-row">\n                ';
 if(!matchEnded) { ;
__p += '\n                <input type="number" data-team=\'' +
((__t = (match.team1.code)) == null ? '' : __t) +
'\' name=\'bet1\' value=\'' +
((__t = (match.bet !== undefined ? match.bet.bet1 : "")) == null ? '' : __t) +
'\'>\n                ';
 } else { ;
__p += '\n                  <h2>' +
((__t = (match.bet !== undefined ? match.bet.bet1 : "")) == null ? '' : __t) +
...
__p += '\n                </div>\n                ';
 if(!matchEnded) { ;
__p += '\n                  <input type="number" data-team=\'' +
((__t = (match.team2.code)) == null ? '' : __t) +
'\' name=\'bet2\' value=\'' +
((__t = (match.bet !== undefined ? match.bet.bet2 : "")) == null ? '' : __t) +
'\'>\n                ';
 } else { ;
__p += '\n                  <h2>' +
((__t = (match.bet !== undefined ? match.bet.bet2 : "")) == null ? '' : __t) +
...
var _leaderboards = __webpack_require__(41);
...
var loadBetsData = function loadBetsData() {
  firebase.database().ref('bets/').once('value', function (res) {
    var users = _.values(res.val());
    var ordered = _.orderBy(users, 'points', 'desc');
    (0, _render2.default)(document.getElementById('matchlist'), (0, _leaderboards2.default)({
      data: ordered
    }));
  });
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=site_bundle.js.map